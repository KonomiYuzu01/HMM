...
def main() -> None:
    ...
    evaluation.OUTPUT = Path("output/hmm_nineteenth_wave_validation")
    evaluation.CANDIDATES = {
        "volatility_acceleration": {
            "normal": Path(
                "output/research_hmm_volatility_acceleration_restarts5"
            ),
            "proxy": Path(
                "output/research_hmm_volatility_acceleration_restarts5_20y_proxy"
            ),
        }
    }
    evaluation.main()
