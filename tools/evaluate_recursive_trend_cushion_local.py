...
OUTPUT = Path("output/recursive_trend_cushion_local")
...
NEIGHBORS = (
    replace(CENTRAL, name="bear_075", bear_multiplier=7.5),
    replace(CENTRAL, name="bear_085", bear_multiplier=8.5),
    replace(CENTRAL, name="floor_175", floor_drawdown=-0.175),
    replace(CENTRAL, name="floor_185", floor_drawdown=-0.185),
    replace(CENTRAL, name="tier_05", tier_size=0.05),
    replace(CENTRAL, name="tier_15", tier_size=0.15),
)
