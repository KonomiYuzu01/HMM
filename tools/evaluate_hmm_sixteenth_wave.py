...
def main() -> None:
    ...
    evaluation.OUTPUT = Path("output/hmm_sixteenth_wave_validation")
    evaluation.CANDIDATES = {
        "pca_whiten": {
            "normal": Path("output/research_hmm_pca_whiten"),
            "proxy": Path("output/research_hmm_pca_whiten_20y_proxy"),
        }
    }
    evaluation.main()
