...
OUTPUT = Path("output/recursive_trend_cushion_budget")
...
NEIGHBORS = (
    replace(CENTRAL, name="floor_17", floor_drawdown=-0.17),
    replace(CENTRAL, name="floor_19", floor_drawdown=-0.19),
    replace(CENTRAL, name="bull_50", bull_multiplier=50.0),
    replace(CENTRAL, name="bull_200", bull_multiplier=200.0),
    replace(CENTRAL, name="bear_05", bear_multiplier=5.0),
    replace(CENTRAL, name="bear_07", bear_multiplier=7.0),
