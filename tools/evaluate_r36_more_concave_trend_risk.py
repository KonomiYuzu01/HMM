...
OUTPUT = Path("output/r36_more_concave_trend_risk")
CANDIDATE = "base1070_relative135_cash18_one_day_unlevered_shock"
BASE_MULTIPLIER = 1.070
ACTIVE_MULTIPLIER = 1.35
SHOCK_MULTIPLIER = 1.00
CASH_FLOOR = -0.18
BASE_NEIGHBORS = (1.065, 1.075)
ACTIVE_NEIGHBORS = (1.30, 1.40)
SHOCK_NEIGHBORS = (0.95, 1.05)
CASH_NEIGHBORS = (-0.16, -0.20)
CUMULATIVE_TRIALS = 109
